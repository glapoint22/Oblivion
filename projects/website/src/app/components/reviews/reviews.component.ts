...
export class ReviewsComponent implements OnInit {
  ...
  public reviewFilterDropdownList: Array<KeyValue<string, string>> = [{ key: 'Filter by All Stars', value: 'all-stars' }, { key: 'Filter by 5 Stars', value: 'five-stars' }, { key: 'Filter by 4 Stars', value: 'four-stars' }, { key: 'Filter by 3 Stars', value: 'three-stars' }, { key: 'Filter by 2 Stars', value: 'two-stars' }, { key: 'Filter by 1 Star', value: 'one-star' },];
  public reviewSortDropdownList: Array<KeyValue<string, string>> = [{ key: 'Sort by High to Low Rating', value: 'high-to-low' }, { key: 'Sort by Low to High Rating', value: 'low-to-high' }, { key: 'Sort by Newest to Oldest', value: 'newest-to-oldest' }, { key: 'Sort by Oldest to Newest', value: 'oldest-to-newest' }, { key: 'Sort by Most Helpful', value: 'most-helpful' },];
  public showButton!: boolean;
  public totalReviews: number = 11;
