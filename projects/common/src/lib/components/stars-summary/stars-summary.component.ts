...
import { ReviewSummaryPopupComponent } from '../review-summary-popup/review-summary-popup.component';
...
export class StarsSummaryComponent {
  ...
  async OpenReviewSummaryPopup() {
    ...
    this.lazyLoadingService.load(async () => {
      const { ReviewSummaryPopupComponent } = await import('../review-summary-popup/review-summary-popup.component');
      const { ReviewSummaryPopupModule } = await import('../review-summary-popup/review-summary-popup.module');
