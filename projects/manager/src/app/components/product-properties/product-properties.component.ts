...
import { BuilderType, MediaLocation, PopupArrowPosition, SubproductType } from '../../classes/enums';
...
export class ProductPropertiesComponent {
  ...
  public async openMediaBrowser(): Promise<void> {
    this.lazyLoadingService.load(async () => {
      ...
      .then((mediaBrowser: MediaBrowserComponent) => {
        ...
        mediaBrowser.init(MediaType.Image, this.product.image, this.getMediaReference(), ImageSizeType.Medium, this.product.name);
  ...
  public removeProductImage() {
    ...
    this.dataService.post('api/Media/MediaReferences/Remove', [this.getMediaReference()]).subscribe();
